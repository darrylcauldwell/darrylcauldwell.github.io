...
We can then check OVS flow tables 100 and see the flow action is set to deny and 
...
We can also see that in table 90 additional flow records are created.

```
kubectl exec -it antrea-agent-czksb -c antrea-agent ovs-ofctl dump-flows br-int | grep table=90

 cookie=0xcac6000000000000, duration=5573.500s, table=90, n_packets=44660, n_bytes=8994443, priority=210,ct_state=-new+est,ip actions=resubmit(,105)

 cookie=0xcac6000000000000, duration=5573.500s, table=90, n_packets=2238, n_bytes=166800, priority=210,ip,nw_src=172.16.1.1 actions=resubmit(,105)

 cookie=0xcac6050000000000, duration=319.641s, table=90, n_packets=0, n_bytes=0, priority=200,ip,reg1=0xa actions=conjunction(1,2/2)

 cookie=0xcac6050000000000, duration=463.747s, table=90, n_packets=0, n_bytes=0, priority=200,ip,reg1=0x8 actions=conjunction(1,2/2)
 
 cookie=0xcac6050000000000, duration=319.641s, table=90, n_packets=0, n_bytes=0, priority=190,conj_id=1,ip actions=resubmit(,105)
 
 cookie=0xcac6000000000000, duration=5573.500s, table=90, n_packets=39, n_bytes=3968, priority=0 actions=resubmit(,100)
```