...
To keep costs low my home lab runs on low power unsupported hardware with simple flat physical networking. While updating to lab to vSphere 7 and NSX 3.0 I took chance to rebuild lab and consolidate much of the  configuration I'd applied iteratively.
